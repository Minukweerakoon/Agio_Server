      ...
      try {
        ...
        if (appointmentsResponse.length > 0) {
            ...
            try {
                ...
                console.log(`Error occured when retrieving employee records for the given ids @getTodaysAppointments() @medSMSScheduler => `, error)
            }
        }
      } catch (error) {
        console.log(
    ...
    if (appointmentList.length > 0) {
        for (a of appointmentList) {
            ...
            try {
                ...
                console.log(`Error occured when sending message to ${a.employeeId} @sendEmployeesMessages() @medSMSScheduler => `, error)
            }
        }
    }
}
...
const sendDoctorsMessage = async () => {
    if (availableDate != null) {
        ...
        try {
            ...
            console.log(`Error occured when sending message to the doctor @sendDoctorsMessages() @medSMSScheduler => `, error)
        }
    }
}
